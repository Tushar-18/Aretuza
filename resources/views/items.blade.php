...
<body class="bg-zinc-900 p-20">
      <div class="bg-zinc-800 w-auto h-auto p-20 flex rounded-lg">
            <div class="first-part">
                  <img src="images/Remnant.jpg" class=" w-96 h-96 hover:transition delay-75 duration-300 ease-in-out hover:-translate-y-1" alt="errer">
            </div>
