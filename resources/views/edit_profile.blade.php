     ...
     <div class="bg-zinc-900 h-full px-96 py-40 w-full">
          ...
          <div class="bg-zinc-800 h-full w-full rounded-3xl">
               <div class="flex items-center justify-center">
                    <img src="images/profile.png" alt="network not comeing" class="rounded-full hover:shadow-xl hover:shadow-zinc-700 bg-zinc-600 -mt-20 h-52 w-52">
               </div>
                    ...
                    <form action="edit-profile" method="POST" class="w-full">
                      @csrf
                         <div class="md:flex md:items-center mb-6">
                           ...
                           <div class="w-full">
                             <input class="bg-zinc-700 focus:bg-zinc-700 appearance-none border-2 border-zinc-600 rounded w-full py-2 px-4 text-gray-200 leading-tight focus:outline-none focus:border-zinc-500" id="inline-full-name" type="text" name="name" placeholder="Name">
                         ...
                         <button class="shadow bg-blue-600 w-full btn-hover hover:bg-blue-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit" name="btn_update">
                              <a href="{{URL::to('/')}}/edit_users/{{$data['id']}}">Update</a>
                         </button>
                       </form>
               </div>
          </div>
