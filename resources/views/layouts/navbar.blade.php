...
<body>
    <div class="container-main">
        <header class="header">
            <div class="logo w-40"><a href="/"><img src="{{ URL::to('/') }}/Images/white-logo.png"
                        alt="error"></a></div>
            <nav class="nav px-5">
                <ul>
            ...
            <div class='max-w-md mx-auto w-96'>
                <div
                    ...
                    <div class="grid place-items-center h-full w-12 text-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 stroke-black" fill="none"
    ...
    <section class="bg-zinc-900">
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            <nav class="flex flex-wrap justify-center -mx-5 -my-2 w-full">
                <div class="px-5 py-2">
                    <a href="aboutus" class="text-base leading-6 text-gray-500 hover:text-gray-600">About
                    </a>
                </div>
                <div class="px-5 py-2">
                ...
                <div class="px-5 py-2">
                    <a href="contactus" class="text-base leading-6 text-gray-500 hover:text-gray-600">
                        Contact
                    </a>
                </div>
                <div class="px-5 py-2">
            ...
            <p class="mt-8 text-base leading-6 text-center text-gray-400">
                © 2023 Aretuza, Inc. All rights reserved.
            </p>
        </div>
    </section>
</body>
