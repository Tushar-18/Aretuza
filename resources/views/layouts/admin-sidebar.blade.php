...
<div class=" flex flex-row bg-gray-100 h-screen ">
  <div class="flex flex-col w-60 bg-white rounded-r-3xl overflow-hidden">
    ...
    <ul class="flex flex-col py-4">
      ...
      <li>
        <a href="{{URL::to('/')}}/admin/aboutus" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500  hover:text-gray-800">
          <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="bx bx-chat"></i></span>
          <span class="text-sm font-medium">Aboutus</span>
        </a>
    </li>
      <li>
        <a href="{{URL::to('/')}}/admin/contactus" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500  hover:text-gray-800">
          <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="bx bx-chat"></i></span>
     ...
     {{-- <li>
      ...
      <li> --}}
        <a href="{{URL::to('/')}}/logout_action" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
