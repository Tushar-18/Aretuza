    ...
    <div class="-my-2 py-2 overflow-x-auto overflow-hidden sm:-mx-6 sm:px-6 lg:m-8  pr-10 lg:px-8 flex flex-col items-center w-full">
        <div class="align-middle rounded-tl-lg rounded-tr-lg inline-block w-full py-4 overflow-hidden bg-white shadow-lg px-12">
            <div class="flex justify-between">
                ...
                <a href="{{URL::to('/')}}/admin/add-user-reg"
                ...
                <tbody class="bg-white">
                    @foreach ($data as $d)
                        ...
                        <tr class="hover:bg-zinc-50">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                <div class="text-sm leading-5 text-blue-900">{{$d['fullname']}}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{$d['email']}}</td>
